...
\cvachievement{\faLeaf}{Image recognition of whales}{Together in a team, we tried building a system that would recognize individual North Atlantic Right Whales from images to help a group of marine biologist in tracking the spices}


\cvachievement{\faWifi}{Wifi fingerprinting}{Through the use of WiFi sniffing and statistical machine learning, in collaboration with a team, we dynamically build a models of the building and estimated the location of the sniffing phone.}
...
\cvachievement{\faPlug}{Motion sensor}{In a 4 month project, a team and I developed a sensor that registred people walking on a stair. Through the use of a Arduino data would be collected on a server}
